 ...
 * @author Alfredo
 */
public class menuModificarItemCotizacion extends javax.swing.JFrame {

    /**
     * Creates new form menuAgregarItemCotizacion
     */
    public menuModificarItemCotizacion() {
        this.setTitle("Ventana Modificar Item Cotizacion");
        initComponents();
        this.txt_descripcion.setLineWrap(true);
        vista.cotizacion.menuModificarItemCotizacion.txt_idListadoCotizacion.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        btnAgregarItem.setText("MODIFICAR");
        ...
        txt_idListadoCotizacion.setText("0000");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txt_valorITem, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_precioUnitario, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnAgregarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarItemActionPerformed
        try {
            ...
            int idCotizacion = Integer.parseInt(vista.cotizacion.menuModificarItemCotizacion.txt_idCotizacion.getText());
            long subTotal = Long.parseLong(this.txt_valorITem.getText().replace(".", ""));
            int idListadoCotizacion = Integer.parseInt(vista.cotizacion.menuModificarItemCotizacion.txt_idListadoCotizacion.getText());
            int cantidad = Integer.parseInt(vista.cotizacion.menuModificarItemCotizacion.txt_cantidad.getText().replace(".", ""));
            long precioUnitario = Long.parseLong(vista.cotizacion.menuModificarItemCotizacion.txt_precioUnitario.getText().replace(".", ""));

            //Crear item:
            CotizacionDao cotix = new CotizacionDao();
            if (cotix.modificarListadoCotizacion(descripcion,cantidad,precioUnitario,subTotal, idListadoCotizacion)) {
...
//            java.util.logging.Logger.getLogger(menuModificarItemCotizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new menuModificarItemCotizacion().setVisible(true);
//            }
//        });
//    }
    ...
    public static javax.swing.JTextField txt_valorITem;

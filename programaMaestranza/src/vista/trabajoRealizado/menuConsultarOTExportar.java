 ...
 * @author Alfredo
 */
public class menuConsultarOTExportar extends javax.swing.JFrame {

    /**
     * Creates new form menuConsultarOTInsumos
     */
    public menuConsultarOTExportar() {
    ...
    private void tablaOrdenTrabajoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaOrdenTrabajoMouseClicked
        if (evt.getClickCount() ==2) {
            ...
            vista.trabajoRealizado.menuTrabajoRealizado.txt_NroOT.setText(String.valueOf(numeroOT));
            this.dispose();
        }

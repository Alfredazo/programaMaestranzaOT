 ...
 * @author Alfredo
 */
public class menuConsultarOTTrabajosRealizadosListar extends javax.swing.JFrame {

    /**
     * Creates new form menuConsultarOTInsumos
     */
    public menuConsultarOTTrabajosRealizadosListar() {
    ...
    private void tablaOrdenTrabajoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaOrdenTrabajoMouseClicked
        if (evt.getClickCount() ==2) {
            ...
            vista.trabajoRealizado.menuListarTrabajoRealizado.txt_nroOT.setText(String.valueOf(numeroOT));
            this.dispose();
        }

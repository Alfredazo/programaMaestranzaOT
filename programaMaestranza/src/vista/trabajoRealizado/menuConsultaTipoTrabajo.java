 ...
 * @author Alfredo
 */
public class menuConsultaTipoTrabajo extends javax.swing.JFrame {
     ...
     */
    public menuConsultaTipoTrabajo() {
    ...
    private void tablaTipoTrabajoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaTipoTrabajoMouseClicked
        try{
            if (evt.getClickCount()==2) {
                ...
                vista.trabajoRealizado.agregarITEMTrabajoRealizado.txt_tipoTrabajo.setText(String.valueOf(idTipoTrabajo));
                vista.trabajoRealizado.agregarITEMTrabajoRealizado.txt_horasTrabajadas.setText("0");
                this.dispose();
            }            
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e.getMessage());
...
//            java.util.logging.Logger.getLogger(menuConsultaTipoTrabajo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new menuConsultaTipoTrabajo().setVisible(true);
//            }
//        });
//    }

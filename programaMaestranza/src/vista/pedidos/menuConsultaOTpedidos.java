 ...
 * @author Alfredo
 */
public class menuConsultaOTpedidos extends javax.swing.JFrame {

    /**
     * Creates new form menuConsultaOTpedidos
     */
    public menuConsultaOTpedidos() {
        this.setTitle("Ventana consultar Nro° Orden de Trabajo");
        initComponents();
...
//            java.util.logging.Logger.getLogger(menuConsultaOTpedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new menuConsultaOTpedidos().setVisible(true);
//            }
//        });
//    }

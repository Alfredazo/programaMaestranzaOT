 ...
 * @author Alfredo
 */
public class menuConsultarOTInsumos extends javax.swing.JFrame {

    /**
     * Creates new form menuConsultarOTInsumos
     */
    public menuConsultarOTInsumos() {
    ...
    private void tablaOrdenTrabajoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaOrdenTrabajoMouseClicked
        if (evt.getClickCount() ==2) {
            ...
            vista.insumos.menuInsumo.txt_nroOT.setText(String.valueOf(numeroOT));
            this.dispose();
        }

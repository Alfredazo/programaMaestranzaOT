 ...
 * @author Alfredo
 */
public class menuConsultarOTInsumosListar extends javax.swing.JFrame {

    /**
     * Creates new form menuConsultarOTInsumos
     */
    public menuConsultarOTInsumosListar() {
    ...
    private void tablaOrdenTrabajoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaOrdenTrabajoMouseClicked
        if (evt.getClickCount() ==2) {
            ...
            vista.insumos.menuListarInsumos.txt_numeroOT.setText(String.valueOf(numeroOT));
            this.dispose();
        }
